...
$pageTitle = "Rechazar Vacaciones - El Agreval";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE VACACIONES SET estado_aprobacion = 'rechazada', estado = 0, comentario_rrhh = ? WHERE id_vacaciones = ?";
    $stmt = $conn->prepare($sql);
    ...
    if ($stmt->execute()) {
        ...
        $asunto = 'Respuesta a tu solicitud de vacaciones';
        $contenido = "
        <h3>Hola, $nombre_empleado</h3>
        <p>Lamentamos informarte que tu solicitud de vacaciones ha sido <strong>rechazada</strong> por Recursos Humanos.</p>
        ...
        <p>Si necesitas discutir esta decisión o tienes alguna duda, no dudes en contactarnos.</p>
        ...
        header("Location: index.php?mensaje=Solicitud de vacaciones rechazada exitosamente&tipo=success");
        exit();
    } else {
        $error = "Error al rechazar la solicitud de vacaciones: " . $stmt->error;
    }
}
?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Rechazar Solicitud de Vacaciones</h1>
    ...
    <div class="bg-base-100 shadow-xl rounded-lg p-6">
        ...
        <form method="POST" class="mt-8">
            <div class="form-control">
                ...
                <textarea name="comentario" class="textarea textarea-bordered h-24" required placeholder="Explique el motivo por el cual se rechaza esta solicitud de vacaciones..."></textarea>
            </div>

            <div class="flex justify-end space-x-4 mt-6">
                <a href="index.php" class="btn btn-ghost">Cancelar</a>
                <button type="submit" class="btn btn-error" onclick="return confirm('¿Está seguro de rechazar esta solicitud de vacaciones?');">
                    Rechazar Vacaciones
                </button>
            </div>
        </form>
