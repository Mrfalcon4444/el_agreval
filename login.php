    ...
    <div class="card-body">
      ...
      <form action="auth/procesar_login.php" method="POST" class="space-y-6">
        ...
        <div class="form-control w-full">
          ...
          <div class="relative">
            <!-- Botón del ojo con fondo y borde -->
            <button type="button" id="togglePassword" 
              class="absolute inset-y-0 left-0 flex items-center pl-3 pr-3 bg-blue-100 border-r border-white h-full rounded-l-md">
            ...
            <!-- Campo de contraseña -->
            <input type="password" name="contraseña" id="password" required placeholder="Contraseña"
              class="input input-bordered w-full pl-12 pr-3 bg-blue-100 rounded-md" />
          </div>
